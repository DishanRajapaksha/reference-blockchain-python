...
class Blockchain(object):
    ...
    def new_block(self, proof, previous_hash=None):
        ...
        :param previous_hash: (Optional) <str> Hash of thr previous block
    ...
    def new_transaction(self, sender, recipient, amount):
        """
        Creates a new transaction that goes into the next mined block
    ...
    def resolve_conflicts(self):
        """
        Replaces current chain with the longest one in the network.
